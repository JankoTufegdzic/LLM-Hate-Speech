...
-   To run the scraper, use the following command, replacing `{newspapers_name}` with the name of the newspaper and `{broj article_number}` with the number of articles you want to scrape:
